...
<h3>從上圖中，我們可以看出：
  <ul>
    ...
    <li>替代空間的藝術工作者占此問卷的第二多</li>
    <li>大多數藝術工作者採取減少包裝及使用再生能能源的行動來減少碳排放量</li>
    <li>而美術館的藝術工作者減少碳排放的行動的第一名是節約工作場所的能源，和其他場所的藝術工作者相比，比較不一樣</li>
  </ul>
</h3>
`
)}
...
d3
  ...
  .range(["#113285","#005CAF","#6E75A4","#7B90D2","#7D532C","#E79460","#A36336"])
  .unknown("#81C7D4")
)}
